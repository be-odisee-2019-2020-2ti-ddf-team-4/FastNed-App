...
import be.fastned.application.domain.OtherImpl.DocumentatieDoc;
...
import static be.fastned.application.dao.implementations.DocumentatieDocHibernateDao.BEAN_DAO_NAME;
