...
import be.fastned.application.code.dao.LaadklantHibernateDao;
...
import static be.fastned.application.code.domain.Personen.Laadklant.ENTITY_NAME;
import static be.fastned.application.code.domain.Personen.Laadklant.TABLE_NAME;
