...
import be.fastned.application.code.dao.DocumentatieDocHibernateDao;
...
import static be.fastned.application.code.domain.DocumentatieDoc.ENTITY_NAME;
import static be.fastned.application.code.domain.DocumentatieDoc.TABLE_NAME;
