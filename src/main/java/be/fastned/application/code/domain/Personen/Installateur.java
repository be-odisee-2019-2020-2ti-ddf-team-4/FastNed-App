...
import static be.fastned.application.code.domain.Personen.Installateur.ENTITY_NAME;
import static be.fastned.application.code.domain.Personen.Installateur.TABLE_NAME;
