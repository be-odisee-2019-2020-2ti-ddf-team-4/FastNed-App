...
import be.fastned.application.code.dao.InstallatieHibernateDao;
...
import static be.fastned.application.code.domain.Installatie.ENTITY_NAME;
import static be.fastned.application.code.domain.Installatie.TABLE_NAME;
