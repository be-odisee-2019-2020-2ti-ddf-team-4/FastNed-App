...
import be.fastned.application.code.dao.ProbleemHibernateDao;
...
import static be.fastned.application.code.domain.Probleem.ENTITY_NAME;
import static be.fastned.application.code.domain.Probleem.TABLE_NAME;
