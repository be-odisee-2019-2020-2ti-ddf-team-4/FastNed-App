...
import be.fastned.application.code.dao.ReparatieHibernateDao;
import be.fastned.application.code.domain.Base.Entiteit;
import be.fastned.application.code.domain.Base.EntiteitBaseImpl;
import be.fastned.application.code.domain.Technisch.Bezoek;
...
import static be.fastned.application.code.domain.Reparatie.ENTITY_NAME;
import static be.fastned.application.code.domain.Reparatie.TABLE_NAME;
