...
import be.fastned.application.code.dao.PlannerHibernateDao;
import be.fastned.application.code.dao.Base.BaseDao;
import be.fastned.application.code.domain.*;
...
import static be.fastned.application.code.domain.Personen.Planner.ENTITY_NAME;
import static be.fastned.application.code.domain.Personen.Planner.TABLE_NAME;
