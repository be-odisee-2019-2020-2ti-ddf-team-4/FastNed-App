...
import be.fastned.application.code.dao.LaadsessieHibernateDao;
...
import static be.fastned.application.code.domain.Laadsessie.ENTITY_NAME;
import static be.fastned.application.code.domain.Laadsessie.TABLE_NAME;
