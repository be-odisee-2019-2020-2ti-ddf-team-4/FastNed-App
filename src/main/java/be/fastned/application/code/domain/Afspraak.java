...
import be.fastned.application.code.domain.Technisch.EnumStatus;
import be.fastned.application.code.service.AppRunner;

import javax.persistence.*;
import java.util.ArrayList;

import static be.fastned.application.code.domain.Afspraak.ENTITY_NAME;
import static be.fastned.application.code.domain.Afspraak.TABLE_NAME;
