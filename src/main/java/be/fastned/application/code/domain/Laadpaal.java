...
import be.fastned.application.code.dao.LaadpaalHibernateDao;
...
import static be.fastned.application.code.domain.Laadpaal.ENTITY_NAME;
import static be.fastned.application.code.domain.Laadpaal.TABLE_NAME;
