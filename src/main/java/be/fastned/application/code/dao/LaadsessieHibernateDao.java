...
import be.fastned.application.code.dao.Interfaces.LaadsessieDao;
import be.fastned.application.code.domain.Laadsessie;
import org.springframework.stereotype.Repository;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;

import static be.fastned.application.code.dao.LaadsessieHibernateDao.BEAN_DAO_NAME;
...
public class LaadsessieHibernateDao extends BaseHibernateDao implements LaadsessieDao {
    ...
    private void configureAbstractOperations(){
        ENTITY_NAME_BASE = LAADSESSIE_ENTITY_NAME;
    }
    ...
    public Laadsessie deleteItem(Laadsessie item){
        return (Laadsessie) currentSession().createQuery(String.format("delete from %s where %s = ", ENTITY_NAME_BASE, item.getId())).uniqueResult();
    }
}