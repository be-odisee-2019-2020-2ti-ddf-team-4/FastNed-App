...
import be.fastned.application.code.dao.Interfaces.LaadpaalDao;
import be.fastned.application.code.domain.Laadpaal;
import org.springframework.stereotype.Repository;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;

import static be.fastned.application.code.dao.LaadpaalHibernateDao.BEAN_DAO_NAME;
...
public class LaadpaalHibernateDao extends BaseHibernateDao implements LaadpaalDao {
    ...
    private void configureAbstractOperations(){
        ENTITY_NAME_BASE = LAADPAAL_ENTITY_NAME;
    }
    ...
    public Laadpaal deleteItem(Laadpaal item){
        return (Laadpaal) currentSession().createQuery(String.format("delete from %s where %s = ", ENTITY_NAME_BASE, item.getId())).uniqueResult();
    }
}
