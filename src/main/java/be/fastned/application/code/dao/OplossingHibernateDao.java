...
import be.fastned.application.code.dao.Interfaces.OplossingDao;
import be.fastned.application.code.domain.Oplossing;
import org.springframework.stereotype.Repository;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;

import static be.fastned.application.code.dao.OplossingHibernateDao.BEAN_DAO_NAME;
...
public class OplossingHibernateDao extends BaseHibernateDao implements OplossingDao {
    ...
    private void configureAbstractOperations(){
        ENTITY_NAME_BASE = OPLOSSING_ENTITY_NAME;
    }
    ...
    public Oplossing deleteItem(Oplossing item){
        return (Oplossing) currentSession().createQuery(String.format("delete from %s where %s = ", ENTITY_NAME_BASE, item.getId())).uniqueResult();
    }
}
