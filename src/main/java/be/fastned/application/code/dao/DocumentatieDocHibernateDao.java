...
import be.fastned.application.code.dao.Interfaces.DocumentatieDocDao;
import be.fastned.application.code.domain.DocumentatieDoc;
...
import static be.fastned.application.code.dao.DocumentatieDocHibernateDao.BEAN_DAO_NAME;
