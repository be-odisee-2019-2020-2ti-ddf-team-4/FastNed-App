...
import be.fastned.application.dao.implementations.ProbleemHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Probleem.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Probleem.TABLE_NAME;
