...
import be.fastned.application.dao.implementations.AfspraakHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Afspraak.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Afspraak.TABLE_NAME;
