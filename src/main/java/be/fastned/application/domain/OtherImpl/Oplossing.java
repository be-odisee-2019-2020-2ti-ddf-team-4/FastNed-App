...
import be.fastned.application.dao.implementations.OplossingHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Oplossing.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Oplossing.TABLE_NAME;
