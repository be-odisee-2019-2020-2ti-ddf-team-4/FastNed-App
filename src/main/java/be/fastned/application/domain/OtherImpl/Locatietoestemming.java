...
import be.fastned.application.dao.implementations.LocatietoestemmingHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Locatietoestemming.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Locatietoestemming.TABLE_NAME;
