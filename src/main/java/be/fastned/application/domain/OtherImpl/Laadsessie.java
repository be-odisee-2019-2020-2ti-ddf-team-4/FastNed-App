package be.fastned.application.domain.OtherImpl;

import be.fastned.application.dao.Base.BaseDao;
import be.fastned.application.dao.implementations.LaadsessieHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Laadsessie.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Laadsessie.TABLE_NAME;
...
public class Laadsessie extends EntiteitBaseImpl implements Entiteit {
	...
	*/
	...
	private void setupInitConfig(){
		...
		klasseDao = (BaseDao) AppRunner.getAppContext().getBean(LaadsessieHibernateDao.BEAN_DAO_NAME);
