...
import be.fastned.application.dao.implementations.ReparatieHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Reparatie.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Reparatie.TABLE_NAME;
...
public class Reparatie extends EntiteitBaseImpl implements Bezoek, Entiteit {
	...
	*/
	...
	private void setupInitConfig(){
		...
		klasseDao = (BaseDao) AppRunner.getAppContext().getBean(ReparatieHibernateDao.BEAN_DAO_NAME);
