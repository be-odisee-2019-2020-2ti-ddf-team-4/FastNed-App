...
import be.fastned.application.dao.implementations.LaadpaalHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Laadpaal.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Laadpaal.TABLE_NAME;
