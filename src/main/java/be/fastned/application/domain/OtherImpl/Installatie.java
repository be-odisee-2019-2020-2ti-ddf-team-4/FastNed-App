...
import be.fastned.application.dao.implementations.InstallatieHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.Installatie.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.Installatie.TABLE_NAME;
