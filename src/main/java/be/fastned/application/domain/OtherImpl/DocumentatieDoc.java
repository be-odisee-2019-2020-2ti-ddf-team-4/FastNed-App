...
import be.fastned.application.dao.implementations.DocumentatieDocHibernateDao;
...
import static be.fastned.application.domain.OtherImpl.DocumentatieDoc.ENTITY_NAME;
import static be.fastned.application.domain.OtherImpl.DocumentatieDoc.TABLE_NAME;
