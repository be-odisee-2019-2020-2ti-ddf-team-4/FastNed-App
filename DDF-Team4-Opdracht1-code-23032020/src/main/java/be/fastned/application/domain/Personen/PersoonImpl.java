...
import be.fastned.application.dao.Andere.PersoonHibernateDao;
...
import static be.fastned.application.domain.Personen.PersoonImpl.ENTITY_NAME;
import static be.fastned.application.domain.Personen.PersoonImpl.TABLE_NAME;
