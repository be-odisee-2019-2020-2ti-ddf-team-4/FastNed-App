...
import be.fastned.application.dao.Andere.DocumentatieDocHibernateDao;
...
import static be.fastned.application.domain.Andere.DocumentatieDoc.ENTITY_NAME;
import static be.fastned.application.domain.Andere.DocumentatieDoc.TABLE_NAME;
