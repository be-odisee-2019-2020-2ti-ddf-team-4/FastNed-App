...
import be.fastned.application.dao.Andere.AfspraakHibernateDao;
...
import static be.fastned.application.domain.Andere.Locatietoestemming.ENTITY_NAME;
import static be.fastned.application.domain.Andere.Locatietoestemming.TABLE_NAME;
