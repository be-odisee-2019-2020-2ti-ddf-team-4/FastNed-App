...
import be.fastned.application.dao.Andere.InstallatieHibernateDao;
...
import static be.fastned.application.domain.Andere.Installatie.ENTITY_NAME;
import static be.fastned.application.domain.Andere.Installatie.TABLE_NAME;
