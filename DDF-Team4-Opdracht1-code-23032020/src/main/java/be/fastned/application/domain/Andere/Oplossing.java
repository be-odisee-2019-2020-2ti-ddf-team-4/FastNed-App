...
import be.fastned.application.dao.Andere.OplossingHibernateDao;
...
import static be.fastned.application.domain.Andere.Oplossing.ENTITY_NAME;
import static be.fastned.application.domain.Andere.Oplossing.TABLE_NAME;
